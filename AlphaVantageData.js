(function () {
    ...
    myConnector.getData = function (table, doneCallback) {
        ...
        for(var i=0 ; i<tableau.connectionData.length; i++) {
        
            const url = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol='+tableau.connectionData[i]+'&apikey=QYOWP5SXIHB6BV3X'
    ...
    tableau.registerConnector(myConnector);
        ...
        $("#submitButton").click(function () {
            tableau.connectionData = $("#submitSymbol").val().split(',');
